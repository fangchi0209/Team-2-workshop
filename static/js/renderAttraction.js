...
// favorite display
async function favoriteDisplay() {
  heartIcon.dataset.attractionId = attractionId;
...
heartIcon.addEventListener("click", () => toggleFavorite(heartIcon));
